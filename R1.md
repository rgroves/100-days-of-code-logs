...
### Day 64: Sunday, May 24, 2020

#### **Today's Progress**:

- Put together to demos for the freeCodeCamp Chicago Local Study Group's 1-year
  anniversary session held today.
  - One was a walkthrough on using CSS linear-gradient.
  - The other was a deep dive on how git stores things behind the scenes.
- Also as part of the freeCodeCamp Chicago group, started looking into Jekyll
  for building out freeCodeCampChicago.com.
- Worked a bit on a design idea I had for the Personal Portfolio Project.

#### **Thoughts:**

- Was going to take a break from the Personal Portfolio Project today but
  decided to commit some of the design ideas I was working with.
...
- Build a Personal Portfolio Webpage - A freeCodeCamp Responsive Web Design Project
  \[[live page](https://rgroves.github.io/fcc-rwd-personal-portfolio/)] |
  \[[code](https://github.com/rgroves/fcc-rwd-personal-portfolio)]
  - [Today's Branch](https://github.com/rgroves/fcc-rwd-personal-portfolio/commits/20200524-work)

---

### Day 65: Monday, May 25 2020

#### **Today's Progress**:

- Started working out styling project section of Personal Portfolio site.
- Add other samples to my Gradient Playground CodePen with attempts to animate
  the gradients.
...
- Build a Personal Portfolio Webpage - A freeCodeCamp Responsive Web Design Project
  \[[live page](https://rgroves.github.io/fcc-rwd-personal-portfolio/)] |
  \[[code](https://github.com/rgroves/fcc-rwd-personal-portfolio)]
  - [Today's Branch](https://github.com/rgroves/fcc-rwd-personal-portfolio/commits/20200525-work)
- Exploration of Gradients on CodePen:
  - Gradients Playground on CodePen \[[Full View](https://codepen.io/robertgroves/full/wvKpdQQ)] |
    \[[Editor View](https://codepen.io/robertgroves/pen/wvKpdQQ)]
...
### Day 66: Tuesday, May 26, 2020

#### **Today's Progress**:

- More work on Personal Portfolio Site
  - Adjusting style names
  - Tweaking project section styles
  - Adding Font Awesome for social icons
  - Starting on contact section

#### **Thoughts:**

- Almost finished with mobile-first styling of the Personal Portfolio page,
  just need to complete the last section, perform some additional cleanup, then
  work out styles for larger screens.
- I remember Font Awesome being a lot easier to use in the past. IIRC it was
  link to a style sheet and use the classes for icons. Now there seems to be a
  bunch of hoops to jump to build kits and such. I guess I have to spend more
  time on the site because they certainly didn't have a clear path for what
  should be the most simple use case.
...
- Build a Personal Portfolio Webpage - A freeCodeCamp Responsive Web Design Project
  \[[live page](https://rgroves.github.io/fcc-rwd-personal-portfolio/)] |
  \[[code](https://github.com/rgroves/fcc-rwd-personal-portfolio)]
  - [Today's Branch](https://github.com/rgroves/fcc-rwd-personal-portfolio/commits/20200526-work)

---

### Day 67: Wednesday, May 27, 2020

#### **Today's Progress**:

- More styling work on my Personal Portfolio Page project. Getting close to
  finished!

#### **Thoughts:**

- So close to gettting the last of the freeCodeCamp Responsive Web Design
  projects over teh finish line.
- Super excited because this was one of the reasons for starting #100DaysOfCode,
  to push myself to tackle the design projects.
- I'm still no design master, but I've come a long way in a short time.
...
- Build a Personal Portfolio Webpage - A freeCodeCamp Responsive Web Design Project
  \[[live page](https://rgroves.github.io/fcc-rwd-personal-portfolio/)] |
  \[[code](https://github.com/rgroves/fcc-rwd-personal-portfolio)]
  - [Today's Branch](https://github.com/rgroves/fcc-rwd-personal-portfolio/commits/20200527-work)

---

### Day 68: Thursday, May 28, 2020

#### **Today's Progress**:

- Spent time working on a puzzle project for the next freeCodeCamp Chicago Study
  Group session.
- Made minor tweaks to the Personal Portfolio page project
- Started working through "React: Getting Started" on Pluralsight

#### **Thoughts:**

- React TILs

  - ReactDom.render: renders a react component to the DOM
    - arg1: Component to render (or array of components)
    - arg2: DOM element to insert into
  - Pure Component: has no state
  - JSX: Looks like HTML, but is really a JavaScript eXtension, must be compiled
    to JS
  - Babel: compiler used to convert JSX into React API calls
  - React.createElement: the "magic" behind JSX is this library function that
    creates a React element
    - arg1: element to be created
    - arg2: any element attributes
    - arg3: child of the element being created
  - A component name must start with an uppercase letter.
  - Function components are just JS functions that return a React Component
    - When returning, if you want to split your JSX over multiple lines, use
      parenthesis to wrap the lines.
  - useState: React function that provides a state object
    - arg1: the initial value for the state
    - returns array with two elements:
      - state object (getter)
      - updater function (setter)
  - Dynamic Expressions: JSX supports dynamic JavaScript expressions
    - these must be placed inside curly braces anywhere inside jsx
  - onClick attribute: register a function to be executed when element is
    clicked
    - onClick is case sensitive.
    - handleClick is a common name for a function assigned to onClick
    - must be set to a function reference, e.g. onClick={handleClick}
  - Use <React.Fragment>...</React.Fragment> or the shorthand <>...</> to create
    a parent element that does not introduce a new DOM parent.
  - Props: to pass a prop to a component you specify an attribute of the JSX
    Component Element (just like in html)
    - You can name the props of the component anything you want
    - The component will recieve a "props" object as it's first argument.
      - This argument is typically named: props (could be named anything, but
        this is a convention)
    - The props object has a key/value pair for each attribute defined
    - All function components recieve this object, even if they have no attributes
  - One-Way Flow of Data: Parent components can flow thier data and/or behavior
    down to children components
  - Aim to create reusable components
  - Tree Reconciliation: React only regenerates nodes, within the rendered root
    DOM node, that actually needs to be regnerated. Everything else stays the
    same—possible because of React's Virtual DOM and because we have a
    representation of the UI in memory (because it's written in JS)
    - React keeps the last UI version in memory
    - When it has a new version it will be in memory as well
    - React can diff the two versions to find the differences and instruct
      the browser to only update the diffs.
  - React removes a layer of complexity when it comes to updating a UI
    - React is declarative
    - We don't have to worry about the steps needed to update the UI.
    - We can focus on data and state, and let React decide when/how to update
      the UI
...
- Build a Personal Portfolio Webpage - A freeCodeCamp Responsive Web Design Project
  ...
  - [Today's Branch](https://github.com/rgroves/fcc-rwd-personal-portfolio/commits/20200528-work)

- Exploration of Puzzle Prototype on CodePen:
  - Puzzle Prototype on CodePen \[[Full View](https://codepen.io/robertgroves/full/XWmLBdx)] |
    \[[Editor View](https://codepen.io/robertgroves/pen/XWmLBdx)]

---

### Day 69: Friday, May 29, 2020

#### **Today's Progress**:

- Still tweaking the Personal Portfolio page project
- Researched best practices for choosing and setting font sizes in CSS.
  - Found a good post on the topic: https://css-tricks.com/accessible-font-sizing-explained/

#### **Thoughts:**

- Probably need to decided when done is done for the portfolio project, because
  I could probably go on tweaking the styles indefinitely.
...
- Build a Personal Portfolio Webpage - A freeCodeCamp Responsive Web Design Project
  ...
  - [Today's Branch](https://github.com/rgroves/fcc-rwd-personal-portfolio/commits/20200529-work)
